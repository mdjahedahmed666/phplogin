  ...
  <body>
   <div class="container-fluid">
       ...
       <h3 class="text-center">Register</h3>
        ...
        <div class="mb-3">
            <input type="text" class="form-control" name="r_phone" placeholder="phone number" required> 
        </div>
        <div class="mb-3">
        ...
        <input type="submit" class="btn btn-primary col-12" class = "form-control" name = "r_submit" value = "Register">
        <a class = "d-flex justify-content-center" href = "login.php">Login Here</a>
        </form>
       </div>
        </div>
